...
**TLDR:** Contributing to Servo taught me how communication is an invaluable
skill, that should be nurtured and cultivated such as writing clean, idiomatic
code.
...
was to learn [Rust]().  To my surprise that is the thing I've learned the least
in the last year of contributing (I'm quite confident reading Rust code, but
writing idiomatic Rust code is a whole different story). What I actually
...
don't want the reponse to my supposedly well crafted question be:

> Can you elaborate, please?

That's no fun. Especially if you have to wait at least 8 hours for a response,
because the opposite developer lives on the other side of the globe in a different
time zone.
...
The answer to this question is pretty straightforward: it depends.

What? This wasn't a helpful answer?
...
- **Put effort into correct spelling, grammar, punctuation and layout:**
  ...
  Make people enjoy reading your comment and they will more likely put effort
  in their response.

- **Never assume the reader knows what your talking about:**
  just because your reader is the team lead with 20+ years of experience,
  doesn't mean he can read your mind and knows what you're struggling with.
...
This list is non-exhaustive. You'll find a ton of valuable information about
asking questions online[^1][^2][^3].
...
more of a communcational skill than a technical one, and therefore
...
## Links
[^1]: [StackOverflow: How do I ask a good question?](https://stackoverflow.com/help/how-to-ask)
[^2]: [Don't ask to ask, just ask](https://www.dontasktoask.com/)
[^3]: [How to ask questions the smart way](http://catb.org/~esr/faqs/smart-questions.html)
